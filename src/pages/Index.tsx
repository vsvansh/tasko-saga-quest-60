...
import { 
  ListFilter, CalendarDays, LayoutDashboard, List, 
  Star, BellRing, Bookmark, Menu, PanelLeft
} from 'lucide-react';
...
const Index: React.FC<IndexProps> = ({ view = 'list' }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-background overflow-hidden">
      ...
      <div 
        className={cn(
          "fixed top-0 left-0 bottom-0 z-40 transition-all duration-300 ease-in-out",
      ...
      <motion.main 
        className={cn(
          "flex-1 px-4 md:px-6 pb-6 transition-all duration-300 ease-in-out", 
